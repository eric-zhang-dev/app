package com.joker.html5;

/**
 * Created by zhangyue on 2016/5/17.
 */
public class Html5 {
    public static String MAIN_HTML = "file:///android_asset/www/main.html";//首页
    ...
    public static String WEATHER_HTML = "file:///android_asset/www/weather_forecast.html";//天气
    public static String STOCK_HTML = "file:///android_asset/www/stock.html";//天气
    public static String CALENDAR = "file:///android_asset/www/calendar.html";
    public static String FOOTBALL = "file:///android_asset/www/football.html";
    public static String NBA = "file:///android_asset/www/nba.html";
